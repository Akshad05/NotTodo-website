...
const Terms = () => {
  return (
    <div className="termsConstainer">
      <h1 style={{ fontSize: "3vw" }}>Terms and Conditions</h1>
      <p>Last updated: July 21, 2023</p>
      <p>
        Please read these terms and conditions carefully before using Our
        Service.
      </p>
      <h1 style={{ fontSize: "3vw" }}>Interpretation and Definitions</h1>
      <h2 style={{ fontSize: "2vw" }}>Interpretation</h2>
      <p>
      ...
      <h2 style={{ fontSize: "2vw" }}>Definitions</h2>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Country</strong> refers to: Goa, India
          </p>
        </li>
        <li>
          <p>
            ...
            this Agreement) refers to NewsBits.
          </p>
        </li>
        <li>
          <p>
      ...
      <h1 style={{ fontSize: "3vw" }}>Acknowledgment</h1>
      <p>
      ...
      <h1 style={{ fontSize: "3vw" }}>Limitation of Liability</h1>
      <p>
      ...
      <h1 style={{ fontSize: "3vw" }}>Governing Law</h1>
      <p>
      ...
      <h1 style={{ fontSize: "3vw" }}>Disputes Resolution</h1>
      <p>
      ...
      <h1 style={{ fontSize: "3vw" }}>For European Union (EU) Users</h1>
      <p>
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which you are resident
        in.
      </p>
      <h1 style={{ fontSize: "3vw" }}>United States Legal Compliance</h1>
      <p>
      ...
      <h1 style={{ fontSize: "3vw" }}>Severability and Waiver</h1>
      <h2 style={{ fontSize: "2vw" }}>Severability</h2>
      <p>
      ...
      <h2 style={{ fontSize: "2vw" }}>Waiver</h2>
      <p>
      ...
      <h1 style={{ fontSize: "3vw" }}>Translation Interpretation</h1>
      <p>
      ...
      <h1 style={{ fontSize: "3vw" }}>Changes to These Terms and Conditions</h1>
      <p>
      ...
      <ul>
        <li>By email: tulaskarakshad1@gmail.com</li>
      </ul>
    </div>
  );
};
