...
const Disclaimer = () => {
  return (
    <div className="disclaimerContainer">
      <h1 style={{ fontSize: "3vw" }}>Disclaimer</h1>
      ...
      <ul>
        <li>
          ...
          this Disclaimer) refers to NewsBits.
        </li>
        <li>
      ...
      <h1 style={{ fontSize: "3vw" }}>External Links Disclaimer</h1>
      <p>
      ...
      <h1 style={{ fontSize: "3vw" }}>Errors and Omissions Disclaimer</h1>
      <p>
      ...
      <h1 style={{ fontSize: "3vw" }}>Fair Use Disclaimer</h1>
      <p>
      ...
      <h1 style={{ fontSize: "3vw" }}>Views Expressed Disclaimer</h1>
      <p>
      ...
      <h1 style={{ fontSize: "3vw" }}>No Responsibility Disclaimer</h1>
      <p>
