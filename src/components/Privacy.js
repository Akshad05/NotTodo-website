...
const Privacy = () => {
  return (
    <div className="privacyContainer">
      <h1 style={{ fontSize: "3vw" }}>Privacy Policy</h1>
      ...
      <h2 style={{ fontSize: "2vw" }}>Types of Data Collected</h2>
      <h3>Personal Data</h3>
      <p>
      ...
      <h2 style={{ fontSize: "2vw" }}>Use of Your Personal Data</h2>
      ...
      <h2 style={{ fontSize: "2vw" }}>Retention of Your Personal Data</h2>
      <p>
      ...
      <h2 style={{ fontSize: "2vw" }}>Transfer of Your Personal Data</h2>
      <p>
      ...
      <h2 style={{ fontSize: "2vw" }}>Delete Your Personal Data</h2>
      <p>
      ...
      <h2 style={{ fontSize: "2vw" }}>Disclosure of Your Personal Data</h2>
      ...
      <h2 style={{ fontSize: "2vw" }}>Security of Your Personal Data</h2>
      <p>
      ...
      <h1 style={{ fontSize: "3vw" }}>Children's Privacy</h1>
      <p>
      ...
      <h1 style={{ fontSize: "3vw" }}>Changes to this Privacy Policy</h1>
      <p>
